...
export function AppSidebar({
  ...
  return (
    <Sidebar collapsible="icon" className="border-r-0 text-white">
      <SidebarHeader className="h-16 border-b border-zinc-700/50 px-4 bg-[#2c2c2c] relative">
            ...
            <SidebarMenu className="gap-3 group-data-[collapsible=icon]:gap-1">
              <SidebarMenuItem>
                <SidebarMenuButton
                  ...
                  tooltip="Dashboard"
                  className="h-11 px-3 rounded-none text-white bg-transparent border-none hover:bg-transparent data-[active=true]:bg-transparent data-[active=true]:text-white data-[active=true]:hover:bg-[#424242] transition-colors text-[0.9em] group-data-[collapsible=icon]:p-2 group-data-[collapsible=icon]:justify-center group-data-[collapsible=icon]:gap-0 group-data-[collapsible=icon]:[&>svg]:text-sky-400"
                >
                    ...
                    <>
                      ...
                      <SidebarMenuItem>
                        <SidebarMenuButton
                          ...
                          className="h-11 pl-8 pr-3 rounded-none text-white bg-transparent border-none hover:bg-transparent data-[active=true]:bg-transparent data-[active=true]:text-white data-[active=true]:hover:bg-[#424242] transition-colors text-[0.9em] relative group-data-[collapsible=icon]:p-2 group-data-[collapsible=icon]:justify-center group-data-[collapsible=icon]:gap-0 group-data-[collapsible=icon]:[&>svg]:text-amber-400"
                        >
